...
def run(csv_file):
    ...
    unique_file_name = csv_file[:-4] + '-unique.txt'
    with open(unique_file_name, 'w') as uwf:
        uwf.write('\n'.join(unique_words))
    ...
    pkl_file_name = csv_file[:-4] + '-freqdist.pkl'
    ...
    bi_pkl_file_name = csv_file[:-4] + '-freqdist-bi.pkl'
    ...
    return pkl_file_name, bi_pkl_file_name
